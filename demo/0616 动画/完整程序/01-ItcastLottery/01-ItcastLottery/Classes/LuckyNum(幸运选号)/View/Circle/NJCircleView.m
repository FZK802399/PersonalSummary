...
{
    return [[NSBundle mainBundle] loadNibNamed:@"NJCircleView" owner:nil options:nil][0];
}
...
- (void)awakeFromNib
{
    ...
    for (int i = 0; i<12; i++) {
        NJCircleItemView *item = [[NJCircleItemView alloc] init];
...
{
    NJCircleItemView *item = (NJCircleItemView *)tap.view;
...
- (void)setCircleType:(ILCircleType)circleType
{
    ...
    for (int i = 0; i<itemCount; i++) {
        NJCircleItemView *item = _items[i];
