...
@interface NJTabBar()
{
    NJTabBarButton *_selectedButton;
}
@end
...
{
    // 1.创建按钮
    NJTabBarButton *button = [NJTabBarButton buttonWithType:UIButtonTypeCustom];
...
- (void)adjustButtonFrames
{
    ...
    for (int i = 0; i < btnCount; i++) {
        NJTabBarButton *button = self.subviews[i];
...
#pragma mark 监听按钮点击
- (void)buttonClick:(NJTabBarButton *)button
{
    // 1.通知代理
